envcpt=function(data,models=c("mean","meancpt","meanar1","meanar2","meanar1cpt","meanar2cpt","trend","trendcpt","trendar1","trendar2","trendar1cpt","trendar2cpt"),minseglen=5,...,verbose=TRUE){
  ...
  if(any(models=="meanar1cpt")|any(models==5)){
      meanarcpt.fit=changepoint::cpt.reg(cbind(data[-1],rep(1,n-1),data[-n]),method="PELT",minseglen=minseglen,...) # default MBIC penalty
  ...
  if(any(models=="meanar2cpt")|any(models==6)){
      meanar2cpt.fit=changepoint::cpt.reg(cbind(data[-c(1:2)],rep(1,n-2),data[2:(n-1)],data[1:(n-2)]),method="PELT",minseglen=minseglen,...) # default MBIC penalty
  ...
  if(any(models=="trendcpt")|any(models==8)){
      trendcpt.fit=changepoint::cpt.reg(cbind(data,rep(1,n),1:n),method='PELT',minseglen=minseglen,...) # default MBIC penalty
  ...
  if(any(models=="trendar1cpt")|any(models==11)){
      trendarcpt.fit=changepoint::cpt.reg(cbind(data[-1],rep(1,n-1),1:(n-1),data[-n]),method="PELT",minseglen=minseglen,...) # default MBIC penalty
  ...
  if(any(models=="trendar2cpt")|any(models==12)){
      trendar2cpt.fit=changepoint::cpt.reg(cbind(data[-c(1:2)],rep(1,n-2),1:(n-2),data[2:(n-1)],data[1:(n-2)]),method="PELT",minseglen=minseglen,...) # default MBIC penalty
